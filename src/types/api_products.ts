...
export interface C_originalPrice {
  value?: number;
  currencyCode: CurrencyCode;
}

export interface C_shippingPrice {
  value?: number;
  currencyCode: CurrencyCode;
}
...
export default interface API_Product {
  ...
  name: string;
  c_api_Fields?: boolean;
  c_brand?: EntityReference[];
  c_discountPercentage?: number;
  c_originalPrice?: C_originalPrice;
  c_parentCategory?: EntityReference[];
  c_shippingPrice?: C_shippingPrice;
  c_shippingType?: string;
